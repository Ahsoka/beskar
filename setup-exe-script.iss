...
OutputBaseFilename=beskar-install-v2.0.0-64bit
...
Source: "dist\Beskar\iconengines\*"; DestDir: "{app}\iconengines"; Flags: ignoreversion recursesubdirs createallsubdirs
